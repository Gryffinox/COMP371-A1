...
// Modified by team Last Minute Formed section DD Summer 2 2021
//
...
void drawGrid(GLint worldMatrixLocation) {
    ...
    //redraw the yellow square i*j times (100*100)
    for (int i = -50; i < 50; i++) {
        for (int j = -50; j < 50; j++) {
...
int main(int argc, char* argv[]) {
    ...
    // Create Window and rendering context using GLFW, resolution is 1024x768 for the assignment
